...
export default function Dashboard() {
  ...
  return (
    <div className="bg-black min-h-screen w-full" style={{ fontFamily: "Inter, sans-serif" }}>
      <div className="flex flex-col md:flex-row">
        {/* Sidebar */}
        <aside className="text-white md:w-64 shrink-0 border-b md:border-b-0 md:border-r border-[#2B4038] p-5">
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm whitespace-nowrap transition-colors ${
                    isActive
                      ? "bg-[#da760c] text-white font-medium"
                  ...
                  {item.id === "manageRequests" && stats.openRequests > 0 && (
                    <span
                      className={`ml-auto text-xs rounded-full px-1.5 py-0.5 ${
                        isActive ? "bg-black text-white" : "bg-white text-[#12201D]"
                      }`}
                    >
                      {stats.openRequests}
                    </span>
...
function StatCard({ label, value, accent }) {
  return (
    <div className="bg-white text-black border border-[#2B4038] rounded-xl px-5 py-4 flex-1 min-w-[140px]">
...
function Overview({ stats, pets, requests }) {
  ...
  return (
    <div>
      <h1 className="text-white text-4xl mb-1" style={{ fontFamily: "Fraunces, serif", fontWeight: 600 }}>
        Dashboard Overview
      </h1>
      <p className="text-white mb-6 text-sm">A snapshot of pets and adoption activity.</p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white text-black border border-[#2B4038] rounded-xl p-5">
